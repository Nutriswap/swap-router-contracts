...
import { abi as FACTORY_V2_ABI, bytecode as FACTORY_V2_BYTECODE } from '@nutriswap/v2-core/build/UniswapV2Factory.json'
...
} from '@nutriswap/v3-periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json'
